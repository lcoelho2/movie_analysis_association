...
--- .class #id
## Associação entre os gêneros
```{r echo= FALSE}
kable(rf,format = "html",caption = "Exemplo de associações obtidas")
```

--- 
Podemos visualizar o relacionamento entre as regras descobertas usando o gráfico abaixo.

![Grouped Matrix](plots/q3r.png) 

---
Podemos também utilizar um dendrogram para visualizar os clusters criados com os gêneros.

![Dendrogram](plots/q3d.png)
